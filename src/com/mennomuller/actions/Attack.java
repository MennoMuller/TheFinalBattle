...
public class Attack extends Action {
    ...
    public Attack(String NAME, String message1, String message2, int dmg, double hitRate) {
    ...
    public static Attack punch() {
        return new Attack("PUNCH", " PUNCHED ", " with their fists.", 1, 1.0);
    }

    public static Attack slash() {
        return new Attack("SLASH", " SLASHED ", " with their SWORD.", 2, 1.0);
    }

    public static Attack boneCrunch() {
        return new Attack("BONE CRUNCH", " used BONE CRUNCH on ", ".", 1, 0.5);
    }

    public static Attack stab() {
        return new Attack("STAB", " STABBED ", " with their DAGGER.", 1, 1.0);
    }

    public static Attack unravel() {
        return new Attack("UNRAVEL", " tried to UNRAVEL ", "'s code.", 2, 0.7);
    }

    public static Attack quickShot() {
        return new Attack("QUICK SHOT", " SHOT an arrow at ", " with their BOW.", 3, 0.5);
    }
}
